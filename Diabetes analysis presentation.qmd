...
| **Outcome**                 | Target variable: **1 (Diabetic), 0 (Non-Diabetic)**. **268 out of 768** patients are diabetic. |
:::
...
- Displays the **distribution across diabetic and non-diabetic groups**.
...
## Analysis - Training Overview

- **Baseline Model** Dummy Classifier  
- Achieved **accuracy = 0.672** (predicting majority class).

**Final Model** Logistic Regression  
- Used **cross-validation** for **hyperparameter tuning**.
- Optimized **C** parameter for better performance.

---

## Analysis - Hyperparameter Tuning
- **RandomizedSearchCV** used to optimize C.
- Explored values from **1e-5 to 1e5**.
- Best C found: **0.027**.
...
param_grid = {"C": loguniform(1e-5, 1e5)}
search = RandomizedSearchCV(LogisticRegression(), param_grid, n_iter=100)
```
